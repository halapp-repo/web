...
it('Delivery Time between 7 - 24  8AM Monday', () => {
  ...
  expect(deliveryTime.format()).toBe(trMoment('2023.01.17 05:00', 'YYYY.MM.DD HH:mm').format());
});
...
it('Delivery Time between 07 - 24 08:00AM Monday - Setting', () => {
  ...
  expect(deliveryTime.format()).toBe(trMoment('2023.01.17 04:00', 'YYYY.MM.DD HH:mm').format());
});
...
it('Delivery Time between 00 - 07 02:00AM Monday 3- Setting', () => {
  ...
  const deliveryTime = getDeliveryTime(currentTime, settingTime);
  expect(deliveryTime.format()).toBe(trMoment('2023.01.16 16:00', 'YYYY.MM.DD HH:mm').format());
});
...
it('Delivery Time between 00 - 07 02:00AM Monday 4- Setting', () => {
  ...
  const deliveryTime = getDeliveryTime(currentTime, settingTime);
  expect(deliveryTime.format()).toBe(trMoment('2023.01.17 01:00', 'YYYY.MM.DD HH:mm').format());
});
