    ...
    <MainCard>
      <Stack sx={{ minHeight: '300px', p: '30px' }} spacing={3}>
        ...
        <table
          ...
          <tbody>
            ...
            <tr>
              <td>_ga_#</td>
              <td>
                Google Analytics tarafından, bir kullanıcının web sitesini kaç kez ziyaret ettiğinin
                yanı sıra ilk ve en son ziyaretin tarihlerine ilişkin verileri toplamak için
                kullanılır.
              </td>
              <td>Üçüncü taraf çerez</td>
              <td>2 yıl</td>
        ...
        <Typography>
          ...
          aracılığıyla da kısmen kontrol sağlanabilmektedir. Sık kullanılan tarayıcılarda çerezlerin
          yönetimine ilişkin bilgilere aşağıdaki bağlantılar aracılığıyla erişebilirsiniz:
        </Typography>
        <ul>
          <li>Google Chrome</li>
          <a
